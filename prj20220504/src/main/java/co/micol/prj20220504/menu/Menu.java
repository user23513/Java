...
public class Menu {
	...
	private void mainMenu() {
		boolean b = false;  //boolean초기값은 false로 두는 것을 원칙으로 한다.
		do {
			mainTitle();
		...
		do {
			...
			switch (code) {
				...
				case 2:
					...
					break;
				case 3:
					System.out.println("공지 사항을 등록한다.");
					break;
				case 4:
					System.out.println("공지 사항을 수정한다.");
					break;
				case 5:
					System.out.println("공지 사항을 삭제한다.");
					break;
				case 6:
					b=true;
					break;
		...
		do {
			...
			switch (code) {
				...
				case 3:
					...
					System.out.println("학생전화번호을 입력하세요.");
					String tel = sc.nextLine();
					System.out.println("학생주소을 입력하세요.");
